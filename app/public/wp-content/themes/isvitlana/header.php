                ...
                <div class="row">
                    <div class="col-md-6">
                        <p class="mb-0">
                            ...
                            if (!empty($tel)):
                                echo '<span ><strong class="icon-phone"></strong> <a href="tel:' .
                                    preg_replace('/[^\d]/', '', $tel) . '" class="p-2">'
                                    . $tel . '</a></span>';
                            endif ?>
                            ...
                            if (!empty($email)):
                                echo '<span><strong class="icon-envelope"></strong> <a href="mailto:'
                                    . $email . '" class="p-2">'
                                    . $email . '</a></span>';
                            endif ?>
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-11 col-xl-2">
                        <h1 class="mb-0 site-logo"><a href="/" class="text-primary h1 mb-0">ISvitlana</a></h1>
                    </div>
