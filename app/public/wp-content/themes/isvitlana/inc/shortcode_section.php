...
function section_shortcode_function($atts)
{
    ...
    $category = get_term_by('name', 'Skills', 'category');
    if ($category) {
    ...
    $args = array(
        ...
        'posts_per_page' => 4, // Количество постов для получения 
            ...
            <div class="row align-items-stretch">
                <div class="col-12 bg-black w-100 ft-feature-1-content">
                    <div class="row  row-cols align-items-center">
                        <div class="col-lg-5">
                            <div class="h-100">
                                <div class="mb-5  align-items-center">
                                    ...
                                    <h2 class="text-center p-3">What do I help? <br> My Skills</h2>
                                </div>
                        ...
                        <div class="row row-cols-2 col-lg-7">

                            <?php
                            $query = new WP_Query($args);
                            while ($query->have_posts()) {
                                $query->the_post(); ?>
                                <div class="col-lg-5 ml-auto mb-5">
