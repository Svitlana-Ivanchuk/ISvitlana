    ...
    <div class="row">
      ...
      foreach ($post_projects as $post):
        ...
        <div class="col-md-6 col-lg-4 mb-4">
          ...
          <a href="<?php the_permalink(); ?>" class="media-1">
      ...
      <div class="testimonial">
        ...
        <blockquote class="mb-5">
          <p>&ldquo;Lorem ipsum dolor sit amet consectetur adipisicing elit. Consectetur unde reprehenderit aperiam quaerat fugiat repudiandae
            explicabo
            animi minima fuga beatae illum eligendi incidunt consequatur. Amet dolores excepturi earum unde iusto.&rdquo;</p>
        </blockquote>
